...
class CuraEnginePluginPatternConan(ConanFile):
    name = "curaengine_plugin_pattern"
    author = "UltiMaker"
    description = "CuraEngine skin and infill pattern generation plugin"
    license = ("agpl-3.0")
    url = "https://github.com/conan-io/conan-center-index"
    homepage = "https://github.com/jellespijker/CuraEngine_plugin_pattern"
    ...
    def layout(self):
        ...
        self.cpp.build.bins = ["curaengine_plugin_pattern"]
    ...
    def package(self):
        ...
        copy(self, pattern=f"curaengine_plugin_pattern{ext}", dst=os.path.join(self.package_folder, "bin"), src=os.path.join(self.build_folder))
    ...
    def deploy(self):
        ext = ".exe" if self.settings.os == "Windows" else ""
        copy(self, pattern=f"curaengine_plugin_pattern{ext}", dst=self.install_folder, src=os.path.join(self.package_folder, "bin"))
